# Hi there, I'm Anil Jiragyale! 👋

### 🤖 AI Engineer · Full Stack Developer · Graduate Intern @ GSK GCC Bangalore
...
[![Profile Views](https://komarev.com/ghpvc/?username=aniljiragyale&color=6366f1&style=flat-square&label=Profile+Views)](https://github.com/aniljiragyale)
...
if __name__ == "__main__":
    anil = Developer()
    print(f"Hi! I'm {anil.name}")
    print(f"Role  : {anil.role}")
    print(f"At    : {anil.company}")
    print(f"Email : {anil.contact()['email']}")
```
...
- 🏢 **Graduate Intern** at **GlaxoSmithKline (GSK) GCC**, Bangalore — building enterprise AI apps
- 🤖 Working with **LLMs, RAG Pipelines, Prompt Engineering** & **Multi-Agent Workflows**
- ⚡ Building scalable **REST APIs** with **FastAPI** and interactive **React** dashboards
- 🎯 Improved enterprise query accuracy by **30%** using AI-powered guardrails
- 🌱 Currently exploring **LangChain, Vector DBs, AWS Cloud & MLOps**
...
│   ├── FastAPI REST APIs for data ingestion & real-time analytics
│   ├── React.js dashboards + Jenkins CI/CD pipelines
...
AIRobosoft — AI / ML Intern                           2023
    ├── COVID-19 spread prediction — 85% accuracy
...
### 🏢 AI-Enabled Data Engineering Platform *(GlaxoSmithKline GCC — Production)*
> Enterprise AI platform with 3 core modules

```
├── ASK CDF       →  LLM chatbot + contextual memory + guardrail validation
├── ER Extractor  →  NLP-powered entity-relationship diagram generator
└── S2T Validator →  AI-driven schema-to-table data validation
```
**Stack:** `Python` `LLM` `RAG` `FastAPI` `React.js` `NLP` `CI/CD`  
**Impact:** +30% data accuracy improvement 🔒 Enterprise / Private

---

### 🧠 COVID-19 Spread Prediction Model
> Machine learning model with 85% prediction accuracy

```
├── LASSO Regression  →  statistical baseline
├── ARIMA             →  time-series forecasting
└── LSTM Neural Net   →  best performer (85% accuracy)
```
...
> Full-stack booking platform with real-time seat management
...
> Responsive e-commerce website live on Netlify
...
### 📸 SM Photography Portfolio
> Multi-device responsive photography portfolio

**Stack:** `HTML5` `CSS3` `JavaScript`  
[![Live Demo](https://img.shields.io/badge/Live_Demo-00C7B7?style=flat-square&logo=netlify&logoColor=white)](https://sm-photography.netlify.app/)

---

## 📊 GitHub Stats

![Anil's GitHub Stats](https://github-readme-stats.vercel.app/api?username=aniljiragyale&show_icons=true&theme=tokyonight&hide_border=true&count_private=true)

![Top Languages](https://github-readme-stats.vercel.app/api/top-langs/?username=aniljiragyale&layout=compact&theme=tokyonight&hide_border=true)

![GitHub Streak](https://streak-stats.demolab.com?user=aniljiragyale&theme=tokyonight&hide_border=true)
